...
export default function StackCard({ icon, text }) {
  ...
  return (
    ...
    >
      <div
        className="size-[120px] flex items-center justify-center border-2 transition-all ease-in-out duration-300 border-primary_purple hover:w-fit hover:px-6 hover:cursor-pointer hover:border-primary_green hover:scale-[110%]"
